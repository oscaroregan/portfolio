...
The project was implemented in MATLAB using the Reinforcement Learning Toolbox and a custom parallel hybrid vehicle model. The full set of MATLAB scripts, models, and training files can be found in the [MATLAB files](../AI-controller/MATLAB) directory.
